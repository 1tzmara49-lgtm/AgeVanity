...
public class Corpse : ThingWithComps, IThingHolder, IThingHolderTickable, IStrippable, IBillGiver, IObservedThoughtGiver
{
    //Config
    ...
    public Corpse()
    {
        ...
        innerContainer = new ThingOwner<Pawn>(this, oneStackOnly: true, contentsLookMode: LookMode.Reference, removeContentsIfDestroyed: false);
    }
    ...
    public override IEnumerable<StatDrawEntry> SpecialDisplayStats()
    {
        ...
        //We used to include mech weight class here, but since race info is now copied to corpses, the RaceProperties handles it in its SpecialDisplayStats
    }
